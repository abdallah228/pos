                                        ...
                                        <tr>
                                            ...
                                            <button class="btn btn-primary btn-sm order-products"
                                                ...
                                                @if (auth()->user()->hasPermission('update_orders'))
                                                    <a href="{{ route('clients.orders.edit', ['client' => $order->clients->id, 'order' => $order->id]) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> @lang('site.edit')</a>
                                                @else
